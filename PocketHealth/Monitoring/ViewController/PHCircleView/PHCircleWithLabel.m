...
-(void)setBackCircleView
{
    ...
    [backCircleView setLineWidth:10.0f];
    [backCircleView setStartAngle:-90.f];
    [backCircleView setEndAngle:270.f];
...
//    [frontCircleView setBackgroundColor:[UIColor clearColor]];
    ...
    [frontCircleView setLineWidth:10.0f];
    [frontCircleView setStartAngle:-90.f];
    [frontCircleView setEndAngle:270.f];
...
-(void)setlabelCentre{
    ...
    [labelCentre setTextColor:[UIColor whiteColor]];
