...
-(void)createVideoNotificiaon{
    //创建关于视频的通知
}
-(void)registerSession{
    long long memberid = [[PHAppStartManager defaultManager]userHost].memberId;
    [ClientHelper regiseterSession:memberid Token:[CommonUtil MyToken] RoomIP:@servierIP RoomID:roomid RoomPort:servierPort];
