...
- (void)initialize;
{
    ...
    _scaleDivisions = KTimeEnd+24-kTimeStart;
    _scaleSubdivisions = 1.0;
//    _showScaleShadow = YES;
    ...
    _value = 0.0;
    _minValue = 0.0;
    _maxValue = KTimeEnd+24-kTimeStart;
...
- (UIColor*)rangeColorForValue:(float)value
{
    ...
    NSLog(@"%f ",[_rangeValues[length - 1] floatValue]);
