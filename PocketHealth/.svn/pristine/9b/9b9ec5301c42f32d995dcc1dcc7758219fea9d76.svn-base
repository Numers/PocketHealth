...
typedef enum {
    ...
    MessageRead = 0, // 已读
    MessageNotRead = 1 ,//未查阅
    MessageNotClickButSee = 2 //未点击 但是已查阅
} MessageReadState;
...
typedef enum {
    ...
    //add by ayngfan 15 3 2
    MessageContentLoginOut = 11,
    
    //add by yangfan 15 410
    MessageContentAVStart = 80 ,//接受视频请求
    MessageContentAVBusyClose = 87, //对方忙 结束视频
    MessageContentAVClose = 88 //正常结束视频
} MessageContentType;
