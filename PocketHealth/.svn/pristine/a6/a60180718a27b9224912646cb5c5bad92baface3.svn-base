...
@class Organization;
@interface PHDetailsHeadViewController : UITableViewHeaderFooterView
...
@property (strong, nonatomic) IBOutlet UIImageView *imgDotLine;
