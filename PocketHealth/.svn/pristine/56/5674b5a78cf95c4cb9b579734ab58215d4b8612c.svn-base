...
-(void)createPHGroupChatTableViewDataSourceMainArray{
    ...
    NSMutableArray * chatingMemberArray = [NSMutableArray arrayWithArray:[sfirenddb selectSessionUserWithoutHospitalWithBelongUid:host.memberId]];
    //对chatingMemberArray 进行排序
    [self sortArrayBySessionDate:chatingMemberArray];
    ...
    noficaionLastMessage.noHandleCount =  [snotifiMsgDB selectNotifcationNoHandleWithHostId:host.memberId];
...
#pragma mark - 对好友排序
-(void)sortArrayBySessionDate:(NSMutableArray *)sortArray;
{
