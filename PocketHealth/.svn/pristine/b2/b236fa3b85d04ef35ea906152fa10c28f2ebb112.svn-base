...
-(void)createBtnInBottom{
    ...
    PHBlueButton * blueBtn = [[PHBlueButton alloc]initWithFrame:CGRectMake(kBtnLeftMargin, 0, kBottomBtnWidth, 44) raised:NO];
    blueBtn.rippleFromTapLocation = NO;
    blueBtn.rippleBeyondBounds = YES;
    blueBtn.backgroundColor = PH_Blue;
    blueBtn.layer.masksToBounds = YES;
    blueBtn.layer.cornerRadius = 4;
