...
#define DefaultImageWidthAndHeight 24.f
...
-(void)setImageView
{
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake((self.frame.size.width-DefaultImageWidthAndHeight) / 2 - 1, (self.frame.size.height - DefaultImageWidthAndHeight)/2 - 1, DefaultImageWidthAndHeight, DefaultImageWidthAndHeight)];
    if (myImage != nil) {
