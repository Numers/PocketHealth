...
#define DefaultChatImageNotLoading @"defult_chatImg_Notloading"
#define DefaultOrganizationHeadImage @"defult_hospital_icons"
#define DefaultGroupHeadImage @"defult_groups_icons"
#define DefaultDoctorHeadImage @"defult_people_icons"
#define TimeOut 10.0f
//#define ServerBaseURL @"http://192.168.83.106/Web"
//#define ServerBaseURL @"ph-web.xugp.com"
#define ServerBaseURL @"http://ph-web.hangp.com"
...
#define PH_AllowJoinGroups  ServerGroupBaseUrl"/AllowJoinGroups"
//群信息修改
#define PH_UpdateGroupInfo_API ServerGroupBaseUrl"/UpGroupInfo"

#define CheckConnectHostUrl SocketChatHostUrl
