...
+ (NSValueTransformer *)doctorJSONTransformer {
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:mDoctor.class];
}
...
//    self.diDepartment = [self.doctor objectForKey:@"Dpname"];
//    self.organizationName = [self.doctor objectForKey:@"Organ_name"];
//    self.diJobTitle = [self.doctor objectForKey:@"Dijobtitle"];
//    self.dimark = [self.doctor objectForKey:@"Diremark"];
    
    self.diDepartment = self.doctor.dpname;
    self.organizationName = self.doctor.organName;
    self.diJobTitle = self.doctor.dijobtitle;
    self.dimark = self.doctor.diremark;
