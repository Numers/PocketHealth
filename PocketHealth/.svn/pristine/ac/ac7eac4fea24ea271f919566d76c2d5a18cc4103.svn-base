            ...
            @autoreleasepool {
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if (message.code == MessageCodeGroupText) {
                        ...
                        if (mCType == MessageContentVoice||mCType == MessageContentImage) {
...
//            }
        ...
        case MessageContentImage:{
            ...
            if (!isGroLoadingChatImage) {
                isGroLoadingChatImage = YES;
