...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = NewBase64Decodes([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
	...
	char *outputBuffer =
		NewBase64Encodes([self bytes], [self length], true, &outputLength);
