//
//  PHPhysicalExamTableReportViewController.m
//  PocketHealth
//
...
@interface PHPhysicalExamTableReportViewController ()<UIWebViewDelegate>
{
    PhysicalExamTable *table;
    UIActivityIndicatorView *activityView;
}
@property(nonatomic, strong) UIWebView *webView;
@end

@implementation PHPhysicalExamTableReportViewController
-(id)initWithPhysicalExamTable:(PhysicalExamTable *)tab
{
    self = [super init];
    if (self) {
        table = tab;
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    [_webView loadRequest:[[PHPhysicalExamTableManager defaultManager] physicalExamTableURLRequestWithEbid:table.ebId]];
}

-(void)viewWillAppear:(BOOL)animated
{
    [super viewWillAppear:animated];
    [self.navigationItem setTitle:@"体检报告详情"];
