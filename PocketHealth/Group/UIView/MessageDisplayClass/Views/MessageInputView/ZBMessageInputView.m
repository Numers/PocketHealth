        ...
        [avSession requestRecordPermission:^(BOOL available) {
            ...
            else
            {
                dispatch_async(dispatch_get_main_queue(), ^{
                    [[[UIAlertView alloc] initWithTitle:@"无法录音" message:@"请在“设置-隐私-麦克风”选项中允许掌上健康访问你的麦克风" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil] show];
                });
            }
        }];
...
- (void)setupMessageInputViewBarWithStyle:(ZBMessageInputViewStyle )style{
    ...
    // 发送语音
    self.voiceChangeButton = [self createButtonWithImage:[UIImage imageNamed:@"chat_btn_inputVoice"]
                                                 HLImage:nil];
    [self.voiceChangeButton setImage:[UIImage imageNamed:@"chat_btn_keyborad"]
    ...
    self.multiMediaSendButton = [self createButtonWithImage:[UIImage imageNamed:@"chat_btn_more"]
                                                    HLImage:nil];
    ...
    // 发送表情
    self.faceSendButton = [self createButtonWithImage:[UIImage imageNamed:@"chat_btn_emotion"]
                                              HLImage:nil];
    [self.faceSendButton setImage:[UIImage imageNamed:@"chat_btn_emotion"]
    ...
    self.holdDownButton = [self createButtonWithImage:[UIImage imageNamed:@"chat_voice_selected"] HLImage:nil];
