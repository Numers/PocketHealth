...
//    [label release];
    ...
    peakImageAry = [[NSArray alloc]initWithObjects:
                    [UIImage imageNamed:@"chat_talk_1"],
                    [UIImage imageNamed:@"chat_talk_2"],
                    [UIImage imageNamed:@"chat_talk_3"],
                    [UIImage imageNamed:@"chat_talk_4"],
                    [UIImage imageNamed:@"chat_talk_5"],
                    [UIImage imageNamed:@"chat_talk_6"],
                    [UIImage imageNamed:@"chat_talk_7"],
                    nil];
...
- (void)updateMetersByAvgPower:(float)_avgPower{
    ...
    if (_avgPower >= -40 && _avgPower < -30)
        ...
        imageIndex = 3;
    _peakMeterIV .layer . masksToBounds = YES;
    _peakMeterIV .layer . cornerRadius = 8 ;
